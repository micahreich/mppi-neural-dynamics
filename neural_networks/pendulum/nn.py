...
if __name__ == "__main__":
    ...
    rollouts_ds = file_dir + "/data/500k_rollouts__23-04-2023 02:38:31.npz"
    singles_ds = file_dir + "/data/500k_singles__23-04-2023 02:38:41.npz"
    ...
    nn.train(rollouts_ds, n_epochs=150, save_model=True, name="pendulum_rollouts")
    nn.train(singles_ds, n_epochs=150, save_model=True, name="pendulum_singles")
